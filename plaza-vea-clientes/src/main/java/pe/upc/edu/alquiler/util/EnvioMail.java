...
public class EnvioMail {
	...
	public boolean envioMailVencidas(String mensaje)
    {
	...
	String fechaAct = format.format(new Date());
    	...
    	boolean x = true;
     	...
     	//	session.setDebug(true);
			...
			String fecha = formateador.format(fechaDate);
             ...
             body.setFrom(new InternetAddress("arquitectura.sw.upc@gmail.com"));
             body.setRecipient(Message.RecipientType.TO, new InternetAddress("mariia.andrea@gmail.com"));
             body.setSubject("Envio Automatico - AVISO DE VENCIMIENTO DE EVALUACION DE SOLICITUD DE ALQUILER DE ESPACIO COMERCIAL ::  PLAZA VEA");
             body.setText("Envío Automatico - Aviso de Vencimiento de Evaluación de Solicitud de Alquiler de Espacio Comercial"+ " " +"\n" + "\n" + 
            		 fecha + "\n" + 
            		 "\n" + 
             		"Estimado(a): " + "\n" + "\n" + 
             		"El presente correo es para comunicarle que el día " + fechaAct + 
             		" se venció el plazo para la evaluación de la solicitud de alquiler de las siguientes solicitudes:." + "\n" +
             		mensaje+
             		"" +"\n" + "\n" + 
             		"Le solicitamos reasignar un nuevo evaluador para cada uno de las solicitudes anteriormente mencionadas," +"\n" + "\n" + 
             		"Sin otro particular reciba nuestros saludos," +"\n" + "\n" + 
             		"Atentamente,"+"\n" + "\n" + 
             		"Plaza Vea");
